...
export interface ConferenceContextType {
    ...
    getConferences: (params: ConferenceQueryParams) => Promise<GetConferencesResponse>;
    getConference: (id: string) => Promise<Conference>;
    updateConference: (id: string, data: UpdateConferenceRequest) => Promise<void>;
    deleteConference: (id: string) => Promise<void>;
    updateConferenceStatus: (id: string, data: UpdateConferenceStatusRequest) => Promise<void>;
...
const ConferenceContext = createContext<ConferenceContextType>({
    ...
    getConferences: async () => ({ conferences: [], pagination: { has_more: false, first_id: '', last_id: '' } }),
